...
Many researchers have applied the OpenTree's synthetic tree and its phylogenetic and taxonomic databases to answer their research questions across the breadth of both the tree of life, and of biological research domains.
...
This large scale synthetic phylogenies provide the opportunity to study the evolution and phylogenetic distribution of organism's life history traits at large scales \citep{tarka2018sex, healy2019animal, capdevila2020longevity}.
Other trait evolution analyses on OpenTree synthetic subtrees include antipredator behavior associations with human interactions, \citep{geffroy2020evolutionary}, effects of anthropogenic noise on
...
OpenTree's synthetic tree provides a phylogenetic backbone for community phylogenetic analyses \citep{li2019common, jantzen2019effects}.
In molecular biology, \citet{boeckmann2015quest} used a phylogenetic estimate across prokaryotes and eukaryotes to understand the evolution
...
sequencing projects.
\citet{miller2020codonpairs} found that codon pairing biases are conserved across the diversity of the tree of life and can be used for phylogenomic analyses.
