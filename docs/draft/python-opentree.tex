...
The OpenTree project makes available thousands of expert-based-knowledge peer-reviewed and published phylogenies that that can be reused for applications
...
Several studies have used OpenTree resources to consolidate evolutionary estimates across a taxon (freshwater crayfish \citep{owen2015synthetic}; birds \citep{brown2017development}; barnacles \citep{ewers2019towards, ewers2019testing}, mammals \citep{uyeda2017evolution})
...
These synthetic phylogenies provide the opportunity to study the evolution and phylogenetic distribution of life history traits at large scales  \citep{tarka2018sex, healy2019animal, capdevila2020longevity}.
Other large scale trait evolution anayses on OpenTree synthesis trees include antipredator behavior associations with human interactions, \citep{geffroy2020evolutionary}, effect of anthropogenic noise on
...
For downstream analyses requiring branch lengths, users have scaled topologies inferred from OpenTree using a variety of external data types and rate-smoothing approaches e.g. \citep{smith2018constructing, smith2019pyphlawd, eastman2013congruification, allen2019spatial, li2019common, uyeda2017evolution, geffroy2020evolutionary, jantzen2019effects}.

OpenTree's synthetic tree provides a phylogentic backbone for commuity phylpogenetics analyses \citep{li2019common, jantzen2019effects}.
In molecular biology, \citep{boeckmann2015quest} used a phylogentic estimate across prokaryotes and eukaryotes to understand the evolution
...
sequencing projects.
\citep{miller2020codonpairs} found that codon pairing biases are conserved across the diversity and can  be used for phylogenomic analyses.
