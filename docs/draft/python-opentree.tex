...
% data and how many by taxonomy, maybe we can say that sometimes mining sequence data
...
They also used the conflict viewer in the curator app to detect conflict between
