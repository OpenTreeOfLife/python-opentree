...
% OpenTree's taxonomy allows supports searches of phylogenies using taxon names
% that will correct misspellings and found synonomies, as well as ancestors or
% descendants of the search taxon.

TreeBASE does not have the possibility of obtaining
...
all eukaryotes for use on comparative analyses. The platform was meant to allow searching the
trees in a taxonomically explicit way, as well as obtaining subtrees of custom sets of taxa.
Unfortunately the website and the trees are not available at moment of writing of
this manuscript, which could explain the small amount of citations it has (8 as of April 2020).
