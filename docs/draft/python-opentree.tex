...
% Probably add here what OpenTree does not do (in response document), as compared to other tools.
...
used for analyses \citep{tree2014tree}.
 ...
 % I need to look for more info on this, I think maybe Phylomatic allows this, I think.
...
% Branch lengths on OpenTree tree were derived from a genetic alignment of data
% downloaded by hand from GenBank, RAxML reconstruction, fossil calibration and dating with r8s.
...
% branch lengths are proportional to time from age data from OpenTree and Congruification
% they tested a model of trait evolution.
% cited 51 times
...
% cited 8 times
% synthetic tree dated with chronograms from Phylesystem.
...
% cited 6 times; used OpenTree synthetic tree and dated it using chronograms in Phylesystem.
...
% with branch lengths estimated using Grafen's 1989 method assuming node heights were raised to the power of 0.5.
...
% they used topology only, no branch lengths, but maybe double check.
